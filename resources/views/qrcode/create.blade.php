                            ...
                            <div class="block w-full">
                                ...
                                <div class=" flex flex-col justify-center items-center text-center">
                                    <div class="visible-print py-6">
                                        {!! QrCode::eye('circle')->style('round')->gradient(255, 0, 0,0, 0, 255,"radial")->color (255, 0, 0)->format('svg')->size(300)->generate(Request::url(route('qr_code.attendance', $id))) !!}
                                    </div>
                                    <div>

                                        <p class=" text-blue-800 py-8">Scan me to Sign your attendance.  </p>
                                        {{-- <p class=" text-blue-800 py-8">Scan me to Sign your attendance.  {{ route('qr_code.attendance', $id) }}</p> --}}
                                    </div>
                                </div>
